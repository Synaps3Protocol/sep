# SEP-004: License Metadata Standard for On-Chain Attestations
...
| **ODRL (Open Digital Rights Language - W3C)** | Conceptual alignment                       | Rich semantic vocabulary for usage permissions, prohibitions and obligations — could be referenced in `termsURI`                    |
...
It is strongly recommended that documents referenced in termsURI are versioned, hash-anchored, and optionally signed digitally (e.g., via PGP, notarization, or platforms like DocuSign) to reinforce trust and enforceability.
