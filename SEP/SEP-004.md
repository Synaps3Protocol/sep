...
- [Specification](#specification)
  ...
  - [LicenseMetadata Schema (JSON)](#licensemetadata-schema-json)
  - [Solidity Struct](#solidity-struct)
- [Compatibility with Existing Standards](#compatibility-with-existing-standards)
- [Security & Validity Considerations](#security--validity-considerations)
- [Example](#example)
- [Conclusion](#conclusion)
- [License Interpretation Rules](#license-interpretation-rules)
