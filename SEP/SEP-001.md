# SEP-001: Multimedia Metadata in Decentralized Networks
...
* [Requirements and Expectations](#requirements-and-expectations)
  ...
  * [Additional Claims](#additiona-claims)
* [Examples](#examples)
...
The majority of media resources are currently transmitted through centralized systems, which are managed by a central authority that controls their consumption, transmission, and management. However, in decentralized environments such as IPFS, there is currently a lack of standardization or specification defining the metadata structure for multimedia resources.

This absence of standardization poses a significant challenge in managing resources, ensuring their security, establishing identity, and transmitting resources among all participating nodes. Furthermore, managing digital rights of resources transmitted across the network presents another substantial challenge, as there are currently no organic action mechanisms in place to establish proof of ownership of digital resources.

To address these challenges, it is imperative to develop a secure standard for metadata structure that can ensure interoperability and facilitate the management of digital rights.
...
JWTs are an industry-standard format, which means they are widely recognized and supported by many programming languages, frameworks, and tools. This makes it easier to integrate JWT-based authentication into your application.

2. Why does it need to be signed?

By allowing verification of the data origin through a digital form, it becomes possible to provide "proof of ownership". We believe that JWTs can be used to encapsulate our current standard and eventually evolve into a secure industry standard, such as through the use of JWS (JSON Web Signature).
...
JWT is used as a container or encapsulating structure for the metadata and MUST follow the basic structure defined in the RFC7519 specification.
