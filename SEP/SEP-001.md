...
Moreover, the standard proposes the use of [DAG-JOSE](http://ipld.io.ipns/specs/codecs/dag-jose/spec/) as a complementary standard for serializing JSON Web Tokens (JWTs), which provides a more secure and robust serialization format that supports JSON General Syntax serialization and binary encoding formats.
