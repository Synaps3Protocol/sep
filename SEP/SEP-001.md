...
When using the JSON compact serialization format, the "claims" field SHOULD use a CID value. This approach preserves the compact and lightweight design of the JWT signature while also giving it a deterministic nature. This enables it to be stored in raw blocks plus fast bitswap.
