...
> Interoperability is one of the main reasons behind the use of JWTs. JWTs are an industry-standard format, widely recognized and supported by many programming languages, frameworks, and tools.
>
> We believe that JSON Web Tokens (JWTs) can encapsulate our current standard and eventually evolve into a more secure standard, through the use of JSON Web Signature ([RFC7515](https://www.rfc-editor.org/rfc/rfc7515)).
