...
* JSON Compact Serialization: This is the default serialization format for JWTs. It combines the header, payload, and signature into a single string, separated by periods. This format is compact and easy to transmit over the wire.
