...
In addition, we recommend the use of [DAG-JOSE](https://ipld.io/specs/codecs/dag-jose/) as the serialization format. It SHOULD be used along with [General JSON Syntax](https://www.rfc-editor.org/rfc/rfc7515#section-7.2.1). [DAG-JOSE](https://ipld.io/specs/codecs/dag-jose/) offers a more secure and robust serialization format that is compatible with the [IPLD](https://ipld.io/) ecosystem.
