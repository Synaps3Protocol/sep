...
3. **"t" technical metadata**
    ...
    Technical metadata MUST represent information that describes the technical characteristics of a multimedia resource. The following fields MAY be included in the "t" claim when they are required according to the multimedia `typ`:
