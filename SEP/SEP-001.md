...
Both JWS and JWE can be serialized in different ways. The most common ways to serialize them are:
  ...
  1. **[JSON Compact Serialization](https://www.rfc-editor.org/rfc/rfc7515#section-7.1)**: This is the default serialization format for JWTs. It represents digitally signed or MACed content as a compact, URL-safe string.
