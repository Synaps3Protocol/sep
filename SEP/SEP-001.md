...
In order to maintain the compact and lightweight design of the JWT signature, the CID is used as the content of the different types of metadata in the JSON compact serialization format:
