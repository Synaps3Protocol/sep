...
By allowing verification of the data origin through a digital form, it becomes possible to provide "proof of ownership". We believe that JWTs can be used to encapsulate our current standard and eventually evolve into a secure standard, such as through the use of JWS (JSON Web Signature).
