...
When using the JSON compact serialization format, the "claims" field SHOULD use a CID value. This maintains the compact, deterministic and lightweight design of the JWT signature and allows it to be stored in raw blocks. The following example demonstrates this:
