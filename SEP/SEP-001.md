...
When using the [JSON Compact Serialization](https://www.rfc-editor.org/rfc/rfc7515#section-7.1) format, the "claims" field SHOULD use a [CID](https://docs.ipfs.tech/concepts/content-addressing/) value pointing to the corresponding JSON. This approach preserves the compact and lightweight design of the JWT signature while also giving it a deterministic nature. This enables it to be stored in raw blocks plus fast bitswap. eg:
...
Additionally, this standard suggests the use of [DAG-JOSE](https://ipld.io/specs/codecs/dag-jose/) as a complementary standard that SHOULD be used for serializing JSON Web Tokens (JWTs). [DAG-JOSE](https://ipld.io/specs/codecs/dag-jose/) supports [General JSON Syntax](https://www.rfc-editor.org/rfc/rfc7515#section-7.2.1) serialization and provides a more secure and robust serialization format that is compatible with the [IPLD](https://ipld.io/) ecosystem.
